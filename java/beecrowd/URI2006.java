...
/*
    ...
    saborear e avaliar a amostra, de modo a identificar o tipo de chá, que pode ser: (1) o chá branco; (2) chá verde; (3) chá preto; ou (4) chá de ervas. 
...
public class URI2006 {
    public static void main(String[] args) throws IOException {
        ...
        String choiceTeas = sc.nextLine();

        List<String> teas = Arrays.asList(choiceTeas.split(""));

        int winners = Collections.frequency(teas, String.valueOf(n));
